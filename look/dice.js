...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-b8cf1e73');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-b8cf1e73');}
...
var brandEl=document.querySelector('.rl-brand-b8cf1e73');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
